 ...
 */
function login() {
    return location.href = "http://47.107.81.63:8085/page/login";
}
function regist() {
    return location.href = "http://47.107.81.63:8085/page/register";
}
...
function search(a) {
    var b = "http://47.107.81.63:8080/search.html?q=" + encodeURIComponent(document.getElementById(a).value);
