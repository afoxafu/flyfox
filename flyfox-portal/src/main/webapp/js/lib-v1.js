...
var category = {OBJ: $("#_JD_ALLSORT"),
		...
		URL_Serv: "http://47.107.81.63:8087/rest/itemcat/list?callback=category.getDataService",
        ...
        return "" == c ? d : (/^http[s]?:\/\/([\w-]+\.)+[\w-]+([\w-.\/?%&=]*)?$/.test(c) || (c = c.replace(/-000$/, ""), c = c.match(/^\d*-\d*$/) ? "http://channel.jd.com/" + c + ".html" : "http://47.107.81.63:8080" + c + ".html"), '<a href="' + c + '">' + d + "</a>")
