...
import com.flyfox.mapper.ContentCategoryMapper;
import com.flyfox.pojo.ContentCategory;
import com.flyfox.pojo.ContentCategoryExample;
import com.flyfox.pojo.ContentCategoryExample.Criteria;
...
public class ContentCategoryServiceImpl implements ContentCategoryService {
	...
	@Override
	public FlyfoxResult insertContentCategory(long parentId, String name) {
		...
		//返回结果
		return FlyfoxResult.ok(contentCategory);
	}
}
